...
export const RECIPES = [
  ...
  { id: "arroz_doce",  label: "Arroz Doce",          emoji: "🍮", need: ["arroz", "leite"],     hunger: 47, xp: Math.round(64 * K.cookXpMultiplier), efeitos: { love: 8, doce: true } },
  { id: "banana_mel",  label: "Banana com Mel",      emoji: "🍌", need: ["banana", "mel"],      hunger: 38, xp: Math.round(48 * K.cookXpMultiplier) },
  { id: "brigadeirinho",label:"Brigadeirinho",       emoji: "🍫", need: ["chocolate", "leite"], hunger: 44, xp: Math.round(56 * K.cookXpMultiplier), efeitos: { love: 14, doce: true } },
